class dummySwapiService {
    ...
    getPeopleAll = async () => {
        return this._peopleAll.results.map(this._transformPerson);
    };

    getPlanetsAll = async () => {
        return this._planetsAll.results.map(this._transformPlanet);
    };

    getStarshipsAll = async () => {
        return this._starshipsAll.results.map(this._transformStarship);
    };

    getStarshipById = async (id) => {
        return this._transformStarship(this._starship);
    };

    getPeopleById = async (id) => {
        return this._transformPerson(this._person);
    };

    getPlanetById = async (id) => {
        return this._transformPlanet(this._planet);
    };
